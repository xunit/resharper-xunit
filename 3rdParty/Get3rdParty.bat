...
if not exist "%ProgramFiles(x86)%\JetBrains\Resharper\v5.1\bin" goto CopyResharper_v60_x86
...
copy "%ProgramFiles(x86)%\JetBrains\ReSharper\v6.0\Bin\JetBrains.Platform.ReSharper.ComponentModel.???" > nul
copy "%ProgramFiles(x86)%\JetBrains\ReSharper\v6.0\Bin\JetBrains.Platform.ReSharper.DocumentManager.???" > nul
copy "%ProgramFiles(x86)%\JetBrains\ReSharper\v6.0\Bin\JetBrains.Platform.ReSharper.DocumentModel.???" > nul
