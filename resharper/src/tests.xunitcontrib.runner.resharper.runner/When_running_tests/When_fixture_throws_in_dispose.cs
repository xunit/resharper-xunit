...
namespace XunitContrib.Runner.ReSharper.RemoteRunner.Tests.When_running_tests
{
    public class When_fixture_throws_in_dispose
    {
        ...
        public void Should_notify_class_exception()
        {
            ...
            testRun.Messages.OfTask(testClass.ClassTask).TaskException(ThrowsInDispose.Exception);
        }
        ...
        public void Should_notify_class_failed()
        {
            ...
            testRun.Messages.OfTask(testClass.ClassTask).TaskFinishedBadly(ThrowsInDispose.Exception);
        }
