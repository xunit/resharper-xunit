...
{
    [Category("xunit2")]
    public class When_collection_fixture_throws_in_constructor : XunitTaskRunnerOutputTestBase
    {
        ...
        public When_collection_fixture_throws_in_constructor()
            : base("xunit2")
        {
        }
        ...
        {
            return "CollectionFixtureThrowsInConstructor";
        }
